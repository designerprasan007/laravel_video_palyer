...
<div class="container-fluid pt-5">
    ...
    <div class="col-md-2 text-center">
        ...
        <div class="pt-3"></div>
        <a href="#" type="button" class="px-4 btn btn-primary">Movies<i class="far fa-hand-point-right pl-3"></i></a>
        <div class="pt-3 text-center"></div>
        <a href="#" type="button" class="px-4 btn btn-primary"> Sports<i class="far fa-hand-point-right pl-3"></i></a>
    </div>
 <div class="col-md-10">
     <div class="row no-gutters">
        <div class="col-md-3">
